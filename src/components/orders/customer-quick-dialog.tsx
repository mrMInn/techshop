...
interface CustomerQuickDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (newCustomer: { id: string; fullName: string; phone: string; leadSourceId?: string | null }) => void;
}

export function CustomerQuickDialog({ 
  isOpen, 
  onClose, 
  onSuccess
}: CustomerQuickDialogProps) {
    ...
    try {
      ...
      if (res.success && res.customer) {
        ...
        onSuccess({
          ...
          leadSourceId: res.customer.leadSourceId,
        });
        // Clear fields
        setFullName("");
        setPhone("");
