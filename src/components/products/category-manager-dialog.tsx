...
export function CategoryManagerDialog({ isOpen, onClose, onUpdate }: CategoryManagerDialogProps) {
    ...
    >
      <div className="space-y-4">
        ...
        <div className="border-t border-[#e0e0e0] pt-4">
          <h3 className="text-[14px] font-semibold text-[#1d1d1f] mb-2.5">Danh sách hiện tại ({categoriesList.length})</h3>
          
          {categoriesList.length === 0 ? (
            <p className="text-[14px] text-[#7a7a7a] text-center py-6">Chưa có danh mục nào.</p>
          ) : (
      ...
      <ConfirmDialog
        ...
        description={`Bạn có chắc chắn muốn xóa danh mục "${itemToDelete?.name}"? Thao tác này không thể hoàn tác và sẽ thất bại nếu danh mục đang được liên kết với sản phẩm.`}
